...
const DEFAULT_ENHANCED_ATS_SYSTEM_PROMPT = [
  ...
  "3. Generate DIRECTLY APPLICABLE improvements with one-click apply support.",
  "4. Every suggestion must specify exact location, explain WHY it hurts ATS score, and provide improved replacement content.",
  "",
