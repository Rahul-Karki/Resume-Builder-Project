...
export const templates: TemplateMeta[] = [
  ...
  { id: "scholarly", name: "Scholarly", tag: "Academic",    category: "Academic",     accent: "#1a1a1a", font: "Libre Baskerville", description: "Centered academic layout with classic headings and balanced spacing.", isPremium: false, palette: ["#FFFFFF","#1a1a1a","#4a4a4a"] },
  { id: "research",  name: "Research",  tag: "Detailed",    category: "Academic",     accent: "#1f1f1f", font: "Libre Baskerville", description: "Publication-style hierarchy tuned for research-heavy resumes.", isPremium: false, palette: ["#FFFFFF","#1f1f1f","#555555"] },
];