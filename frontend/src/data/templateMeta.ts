...
export const templates: TemplateMeta[] = [
  ...
  { id: "chronological", name: "Chronological", tag: "ATS Core", category: "Professional", audience: "non-tech", accent: "#1F2937", font: "IBM Plex Sans", description: "Reverse-chronological ATS layout highlighting role progression for business and office careers.", isPremium: false, palette: ["#FCFCFB","#1F2937","#6B7280"] },
  { id: "functional", name: "Functional", tag: "Skills-First", category: "Professional", audience: "non-tech", accent: "#334155", font: "Outfit", description: "Skills-first ATS-safe resume for career pivots, return-to-work, and experience gaps.", isPremium: false, palette: ["#F8FAFC","#334155","#64748B"] },
  { id: "combination", name: "Combination", tag: "Hybrid", category: "Corporate", audience: "non-tech", accent: "#0B3C5D", font: "Playfair Display", description: "Hybrid ATS format balancing measurable achievements and transferable strengths.", isPremium: true, palette: ["#F8FAFF","#0B3C5D","#64748B"] },
  { id: "traditional-assistant", name: "Traditional Assistant", tag: "Admin", category: "Professional", audience: "non-tech", accent: "#1E3A8A", font: "IBM Plex Sans", description: "Administrative-assistant inspired ATS template focused on office operations and coordination.", isPremium: false, palette: ["#F8FAFF","#1E3A8A","#64748B"] },
  { id: "community-impact", name: "Community Impact", tag: "Volunteer", category: "Professional", audience: "non-tech", accent: "#166534", font: "Lora", description: "Simple ATS-ready format for volunteer, NGO, education support, and public-service resumes.", isPremium: false, palette: ["#F0FDF4","#166534","#6B7280"] },
];
