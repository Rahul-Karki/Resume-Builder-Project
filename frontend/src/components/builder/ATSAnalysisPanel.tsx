...
import { AlertCircle, BarChart3, ChevronDown, FileSearch, Loader2, RefreshCw, Target } from "lucide-react";
        ...
        {!report && !loading && (
          <div className="ats-empty">
            ...
            <div className="ats-empty-text">
              Run an ATS analysis to see section scores and missing keywords.
            </div>
          </div>
        )}
      </div>
