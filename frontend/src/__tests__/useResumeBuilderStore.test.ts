...
describe("useResumeBuilderStore", () => {
  ...
  it("should reset all state when resetAll is called", async () => {
    ...
    store2.setState({ resume: { title: "Untitled Resume", templateId: "classic", personalInfo: { name: "", title: "", email: "", phone: "", location: "", linkedin: "", github: "", portfolio: "", summary: "" }, sections: { experience: [], education: [], skills: [], projects: [], certifications: [], languages: [] }, style: { accentColor: "#1a1a1a", headingColor: "#111111", textColor: "#333333", mutedColor: "#666666", borderColor: "#cccccc", backgroundColor: "#FAF8F5", bodyFont: "EB Garamond, serif", headingFont: "EB Garamond, serif", fontSize: "10.5pt", lineHeight: "1.5", pageMargin: "normal", sectionSpacing: "normal", showDividers: true, bulletStyle: "•", headerAlign: "left" }, sectionOrder: ["experience", "education", "skills", "projects", "certifications", "languages"], sectionVisibility: { experience: true, education: true, skills: true, projects: true, certifications: true, languages: true } }, ui: { activeTab: "content", activeSection: "personal", focusedField: null, previewScale: 0.5, exportPreset: "standard", isSaving: false, isSaved: false, isDirty: false, saveError: null } });
