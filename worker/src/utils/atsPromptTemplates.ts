...
if (!enhancedPromptSource) {
  // Keep ATS analysis available even when prompt files are not mounted in runtime environments.
  console.warn("[worker] ATS prompt template file not found: enhanced_ats_prompt.py. Using built-in fallback prompts.");
}
